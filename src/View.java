...
class View extends JPanel //The view class shows what the user will see.
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        for(int i = 0; i < model.bricks.size(); i++) //This for loop will loop through all of the brick objects
        {
            ...
            g.drawImage(b.brickImage, b.xLocation - model.hCamPos, b.yLocation, b.wDimension, b.hDimension, null); //Draw the ith brick.  Each brick has difference properties, so we use the object, b.
        }
    }
}
